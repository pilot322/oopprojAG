...
public class AccountStatementManagerTest {
    ...
    public void setUp() throws Exception { // Added throws Exception for account creation
        ...
        int recvUserId = userManager.login("recvUser", "pass").getId();
        accountManager.createPersonalAccount(recvUserId, "GR", 0.01, new ArrayList<Integer>());
        ...
        statementIdCounter = 1; // Reset for each test
    }
    ...
    public void testAddStatement_Success_AndGetStatements_Single() {
        ...
        assertEquals(testUserId1, retrieved.getTransactorId());
