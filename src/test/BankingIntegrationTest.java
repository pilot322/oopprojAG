...
public class BankingIntegrationTest {
    ...
    private int indivIdMain, indivIdSec1, indivIdSec2;
    private int companyIdMain;
    ...
    public void testIndividualScenario_AccountManagement() throws Exception { // Added throws Exception
        ...
        int otherCompId = userManager.login("otherComp", "passC").getId();
        ...
        accountManager.createPersonalAccount(indivIdMain, "GR", 0.01, new ArrayList<Integer>());
    ...
    public void testCompanyScenario_AccountManagement() throws Exception { // Added throws Exception
        ...
        // int otherIndivId = userManager.login("otherIndiv", "indPass").getId(); // Not used directly in this test
        ...
        try {
            accountManager.createPersonalAccount(companyIdMain, "US", 0.01, new ArrayList<Integer>());
        ...
        // if (acc instanceof BusinessAccount && acc.getOwnerId() == companyIdMain) {
