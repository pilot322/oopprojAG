...
public class TransactionIntegrationTests {
    ...
    private int userIdIndivA, userIdIndivB, userIdCompA, adminId;
    ...
    public void setUp() throws Exception {
        ...
        // Accounts
        accountManager.createPersonalAccount(userIdIndivA, "GR", 0.01, new ArrayList<Integer>());
        ibanIndivA = accountManager.findAccountsByIndividualId(userIdIndivA).get(0).getIBAN();

        accountManager.createPersonalAccount(userIdIndivB, "GR", 0.01, new ArrayList<Integer>());
    ...
    public void scenario3_BillPaymentByIndividual() throws Exception {
        ...
        // Bill: int id, int businessId, int customerId, String RF, double amount, LocalDateTime timePublished, LocalDateTime expireTime
        String billRF = "BILLRF001";
        double billAmount = 75.0;
        int billId = 101; // example bill ID
        ...
        if (billManager != null) { // Check if BillManager is available
            ...
            // Assuming a method like this exists, or you have a way to populate it.
            // This is a placeholder for actual BillManager interaction.
            // billManager.addBill(testBill);
            // If not, this test will fail when TransactionManager tries to find the bill.
            // For now, we proceed assuming TransactionManager can find it.
        } else {
        ...
        try {
            ...
            System.err.println("Bill payment failed. This might be due to BillManager not finding RF: " + billRF + ". Error: " + e.getMessage());
        ...
        // Bill paidBill = billManager.getBillsByRF(billRF).get(0); // Assuming getBillsByRF returns a list
    ...
    public void scenario4_MultipleTransactionsStatementOrderAndBalanceAfter() throws InterruptedException {
        ...
        assertEquals(500.0, s4.getAmount(), 0.001); // This was the initial funding amount for ibanIndivA
    ...
    public void scenario5_UnauthorizedAttemptsAndOverrides() {
        ...
        // 4. Bank user (-1) successfully withdraws from accountA
